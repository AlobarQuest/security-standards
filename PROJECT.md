...
- [ ] (P1) Rotate the BWS machine-account access token (access-key ID 8ba33ccd-b73e-4924-8c65-b46701587319) — ELEVATED/compromised: accidentally printed into a Claude Code transcript 2026-07-22, treat as exposed not routine. Revoke current token in the Bitwarden Secrets Manager console, issue a new one, update the macOS Keychain entry that ~/Projects/vps-backup/bws-token.sh reads. Folds into the in-progress key-rotation project. — added 2026-07-22
## Future plans
